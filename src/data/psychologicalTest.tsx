...
export const psychologicalTest: TestProps[] = [
  {
    id: 'depression',
    title: '우울증 검사',
    info: {
    ...
    result: {
      common: {
        text: [
          ...
          "우울증은 삶을 매우 고통스럽게 만드는 정신장애인 동시에 '심리적 독감'이라고 불릴 정도로 매우 흔한 장애이기도 합니다. 또한 우울증은 개인의 능력과 의욕을 저하시켜 현실적 적응을 어렵게 만드는 주요한 요인으로 알려져 있습니다. 우울장애는 기간에 따라 다양하게 나뉠 수 있습니다. 최소 2주 이상 우울한 기분이거나 흥미나 즐거움의 상실이 지속되었다면 병원에서 상담받으시는 것을 추천해드립니다.",
          '우울증을 예방하기 위해서는 입증된 방법은 없으나 스트레스 조절, 주변에서의 사회적 지지가 있습니다. 스트레스가 생겼을 때 건강한 방식으로 스트레스를 조절하여 긍정적인 정서로의 변화가 중요할 것입니다. 또한 우울하거나 힘든 날에는 주변 사람들에게 이야기하고 위로를 받는 것 역시 도움이 됩니다.',
        ],
        total: 13,
      },
      types: [
  ...
  },
  {
    ...
    qna: {
      questions: [
        ...
        '9. 처음 보는 사람 앞에서는 긴장이 심하다.',
        '10. 정신 집중을 하기가 힘들다.',
        '11. 권위 있는 사람들을 대할 때 두려운 생각이 든다.',
        '12. 혼자 있을 때도 불안하고 두려운 생각이 든다.',
        '13. 사람들 앞에 설 때 떨린다.',
        '14. 불치병에 걸릴까봐 걱정된다.',
      ],
      answers: [
    ...
    result: {
      common: {
        text: [
          ...
          '하지만, 현실적인 위험이 없는 상황이나 대상에 대해서 불안을 느끼는 경우, 현실적인 위험의 정도에 비해 과도하게 심한 불안을 느끼는 경우, 불안을 느끼게 하는 위협적인 요인이 사라졌음에도 불구하고 불안이 과도하게 지속되는 경우에는 병적인 불안(pathological anxiety)이라고 할 수 있습니다. 이처럼 병적인 불안으로 인하여 과도한 심리적 고통을 느끼거나 현실적인 적응에 심각한 어려움을 겪는 경우를 불안장애(anxiety disorder)라고 합니다. 불안장애는 병적인 불안이 나타나는 양상이나 불안을 느끼는 대상 및 상황에 따라서 여러 가지 하위유형으로 구분될 수 있습니다.',
          "불안한 마음이 드신다면 '지금 나를 보호하기 위해 경계 태세를 취하는구나'라고 생각해 보시고 불안을 다룰 수 있는 다양한 활동을 해보세요. 혹시 불안한 마음이 오랜 시간 동안(최소 6개월 이상) 지속되신다면 병원에 방문해 상담을 받아보시는 것을 추천합니다.",
        ],
        total: 14,
      },
      types: [
    ...
    result: {
      common: {
        text: [
          ...
          '스트레스는 우리 삶의 모든 영역에 존재합니다. 그렇기 때문에 스트레스 사건을 경험하더라도 스트레스에 대한 생각을 바꾼다면 잘 이겨낼 수 있을 것입니다. 따라서, 스트레스 자체보다 스트레스를 어떻게 대처하느냐가 우리 삶에 있어 중요한 요소로 작용할 것입니다.',
          '스트레스 유발 요인으로는 재앙적 사건(태풍, 지진 등), 주요 생활사건(이혼, 배우자의 사망), 그리고 일상의 골칫거리(교통체증, 대인관계)로 나뉠 수 있습니다. 스트레스를 받게 되면 직접적으로는 면역계, 신경계와 내분비계에 영향을 미쳐 여러 질병들을 일으킬 수 있으며, 간접적으로는 음주, 흡연, 수면 문제 등으로 질병의 위험을 증가시키기도 합니다.',
        ],
        total: 54,
      },
      types: [
        ...
        },
        {
          ...
          score: 42,
          title: '중등도의 스트레스 상태',
          img: '/assets/stress_moderate.png',
    ...
    result: {
      common: {
        text: [
          ...
          '각자의 스트레스 유형에 맞는 대처방식을 취하는 것이 좋습니다. 예를 들어, 스트레스 원인이 해결 가능한 것이라면 문제 중심적 대처나 사회적지지 대처가 유용한 방법일 것입니다. 반면에 스트레스 원인이 해결 불가능한 것이라면 해결하려고 힘을 들이며 더 스트레스를 받는 것보다 정서 중심적 대처나 소망 추구적 대처를 취하는 것이 유용할 것입니다.',
        ],
        total: 24,
      },
      types: [
      ...
      types: [
        {
          ...
          title: '개방적인 의사소통을 하고 있습니다.',
          img: '/assets/communication_open.png',
          subTitle:
            '개방적인 의사소통은 정확하고 모순되지 않은 메시지를 보내고, 부모님과의 상호작용에서 억압받지 않고 자유롭게 감정을 표현하는 의사소통입니다. 앞으로도 지금처럼 부모님과 대화를 한다면 부모님과의 관계는 더욱 좋아질 것입니다.',
        },
        {
          level: 1,
          score: [2, 4, 5, 10, 11, 12, 15, 18, 19, 20],
          title: '폐쇄적인 의사소통을 하고 있습니다.',
          img: '/assets/communication_closed.png',
          subTitle:
            '폐쇄적인 의사소통은 일치되지 않고 모순된 메시지를 보내고 부정적인 발언을 하며, 의사소통을 할 때 비난적인 표현을 쓰는 등 역기능적인 의사소통을 말합니다. 부모님과의 신뢰와 애정을 쌓기 위해서는 부모님과 자유롭게 감정을 표현하는 등 의사소통 방식에 변화를 주어야 합니다. ',
        },
        {
          level: 2,
          score: [],
          title: '개방, 폐쇄적 의사소통을 사용하고 있습니다.',
          img: '/assets/communication_neutral.png',
          subTitle:
            '어떤 때에는 부모님과의 상호작용에서 자유롭게 의사소통을 하지만, 또 어떤 날에는 비난적인 표현이나 부정적인 발언을 하기도 합니다. 일관적이지 않은 의사소통은 부모님과 본인에게 혼란을 일으킬 수 있어 의사소통을 피할 수도 있습니다. 일관적이고 자유로운 의사소통을 하신다면 부모님과의 신뢰와 애정을 쌓으실 수 있을 것입니다.',
        },
      ],
    },
  },
